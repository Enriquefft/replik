...
const SYSTEM_PROMPT = [
  ...
  "- productName: SIN sufijo de cantidad o pack. Elimina '2 Uds', 'Pack x 2', 'x3', '× 3', '60 caps', '60 cápsulas', '237 ml', 'Tripack', '3-Pack' y similares. El productName debe identificar el SKU, no el formato de venta. Ejemplo: 'Vitamina B12 B6 B1 Complejo B Energía Cerebro Corazón 2 Uds' → 'Vitamina B12 B6 B1 Complejo B Energía Cerebro Corazón'.",
  ...
  "- keywords.narrow: 3-5 frases largo-cola (3-6 palabras) con intención de compra concreta. CRÍTICO: narrow NO puede ser una extensión léxica de un broad. Si broad incluye 'vitamina b12', narrow NO puede ser 'comprar vitamina b12' ni 'vitamina b12 perú'. narrow debe aportar intención NUEVA: caso de uso ('para memoria adultos mayores'), beneficio específico ('energía sin cafeína'), problema ('cansancio crónico'), o comparativa ('mejor que neurobion').",
  "",
  "Si shape == 'pdp':",
