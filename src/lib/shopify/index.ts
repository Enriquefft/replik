 ...
 */
export async function validateToken(input: ShopifyValidateInput): Promise<ShopInfo> {
  ...
  try {
    ...
    throw new ShopifyAuthError("No se pudo conectar con Shopify. Verifica el dominio.")
  }
  if (!response.ok) {
