...
export function LandingClient({
  ...
  const subheadline =
    overrides.subheadline ?? selectedTemplate?.subheadline ?? "";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 items-start">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="rounded-card bg-surface border border-border shadow-tight p-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <div
                key={pack.label}
                className="rounded-control bg-surface-muted p-3 text-center"
              >
        ...
        {runId && (
          <Button
            ...
            size="lg"
            className="w-full"
            onClick={() => { router.push(`/products/${productId}/launch`); }}
          >
      ...
      <div className="hidden lg:flex flex-col gap-4">
        <p className="text-callout font-semibold text-fg-1 text-center">
          Vista previa
        </p>
        <IphonePreview>
          <div className="px-4 py-6 flex flex-col gap-4">
            ...
            >
              ...
              {subheadline && (
                <p className="text-[11px] mt-1 opacity-80">{subheadline}</p>
              )}
            </div>
