...
import { products, creatives, assets } from "@/db/schema";
      ...
      <div className="mx-auto max-w-4xl flex flex-col gap-6">
        <div>
          ...
          <h2 className="text-title">
            Traduciendo y quemando subtítulos
          </h2>
          <p className="text-body text-fg-2 mt-1">
            Los videos seleccionados están siendo procesados con subtítulos en
            español. Cuando terminen, podrás continuar a la landing.
          </p>
        </div>
