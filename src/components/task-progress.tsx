      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            <p className="text-callout font-medium text-fg-1 truncate">
              {step ?? config.label}
            </p>
            <span className="text-caption text-fg-3 shrink-0">
              {progress}%
            </span>
          </div>
          {detail && (
            <p className="text-caption text-fg-2 mt-0.5 truncate">{detail}</p>
          )}
        </div>
      </div>
